class Circle {
  ...
  class Circle3D {
    ...
    // build geometry (positions + normals) for the current segments/thickness
    _buildMesh() {
    ...
    render() {
      ...
      // build mesh if needed (or if segments/thickness changed)
